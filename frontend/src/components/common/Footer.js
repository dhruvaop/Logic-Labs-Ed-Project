    ...
    <div className='bg-richblack-800' >
      <div className='flex flex-col  text-white w-11/12 max-w-maxContent mx-auto pt-14' >
          ...
          <div className='lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3' >
            ...
            <div className='w-[48%] lg:w-[30%] flex flex-col gap-3 ' >
              ...
              <div className='flex gap-3 text-lg text-richblack-400 -mt-5'>
                <Link to={'https://www.linkedin.com/in/dhruva-bhattacharya/'} ><FaLinkedin /></Link>
                <Link to={'https://twitter.com/DhruvaBhattach2'} ><FaTwitter /></Link>
                <Link to={'https://www.youtube.com/channel/UCx4o0mGSyBHIzsQMG3zHj7Q'} ><FaYoutube /></Link>
                <Link to={'https://www.facebook.com/dhruva130102/'} ><FaFacebook /></Link>
                <Link to={'https://www.instagram.com/bhattacharyadhruva.cjs/'} ><FaInstagram /></Link>
              </div>
            </div>
        ...
        <div className='flex flex-col lg:flex-row justify-between items-center text-richblack-400 text-sm py-14' >
          ...
          Made by 🚀 <a href="dhruvabhattacharya.github.io" style={{ fontWeight: 'bold', color: 'grey' }}>Dhruva Bhattacharya</a> © 2023 Logic Labs Ed
          </div>
        </div>
      </div>
    </div>
